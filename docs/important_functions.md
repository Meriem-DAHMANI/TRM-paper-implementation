...
Example with warmup_steps=1000:
    progress = 0   → 0.5 * (1 + 1)  = 1.0   (100% of LR)
    progress = 0.25→ 0.5 * (1 + 0.707) ≈ 0.85
    progress = 0.5 → 0.5 * (1 + 0)  = 0.5   (50% of LR)
    progress = 0.75→ 0.5 * (1 - 0.707) ≈ 0.15
    progress = 1   → 0.5 * (1 - 1)  = 0.0   (0% of LR)
